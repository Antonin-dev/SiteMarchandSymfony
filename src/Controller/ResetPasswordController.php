...
class ResetPasswordController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                //  1 : Enregistrer en base la demande de reset password avec user, tokem et created at
                ...
                $content = "Bonjour " . $user->getFirstName() . "<br/>Vous avez demandé à reinitialiser votre mot de passe sur le site La Boutique Francaise.<br/><br/>";
                ...
                $this->addFlash('notice', 'Vous allez recevoir dans quelques secondes un mail avec la procédure de reinitialisation de mot de passe.');
            }
            else{
    ...
    public function update($token, Request $request, UserPasswordEncoderInterface $encoder)
    {
        ...
        // Verifier si le created at est supperieur au now
        $now = new DateTime();
